...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final int i1 = simController.nextInt();
        System.out.println("How many cars?");
        final int i2 = (simController.nextInt());
        System.out.println("How many traffic lights?");
        final int i3 = simController.nextInt();
        ...
        for (int a = 0; a < carSpawns; a++) {
            cars.add(new Car(Integer.toString(a), roads.get(0))); // all created cars will begin on road_0.
            cars.get(a).printCarStatus();
        }
